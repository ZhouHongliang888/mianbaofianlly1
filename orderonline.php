...
switch($_GET["action"]) {
	case "add":
		if(!empty($_POST["quantity"])) {
			...
			$itemArray = array($productByCode[0]["code"]=>array('name635'=>$productByCode[0]["name635"], 'code'=>$productByCode[0]["code"], 'quantity'=>$_POST["quantity"], 'price'=>$productByCode[0]["price"], 'image'=>$productByCode[0]["image"]));
...
<head>
  ...
  <title>order online - Luca’s Loaves Bootstrap Template</title>
...
#删减选中的产品代码之处
    foreach ($_SESSION["cart_item"] as $item){
		...
		?>
				<table>
				<tr>
				<td><img src="<?php echo $item["image"]; ?>   " class="cart-item-image" /><?php echo $item["name635"]; ?></td>
...
<div id="product-grid">
	...
	?>
		...
		<div class="image">
			...
			<div class="product-title"><?php echo $product_array[$key]["name635"]; ?></div>
  ...
  <footer id="footer">
    <div class="container">
      ...
      <div class="credits">
        ...
        <!-- Purchase the pro version with working PHP/AJAX contact form: https://bootstrapmade.com/Luca’s Loaves-free-bootstrap-cv-careers-html-template/ -->
